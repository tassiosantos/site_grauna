...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'truenorth');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'True North');
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://cssigniter.com/docs/'.CI_THEME_NAME);
