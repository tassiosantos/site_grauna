...
$evolve_css_data .= '@media only screen and (min-width: 768px) { ul.nav-menu li { -webkit-transition: all .1s ease-in; -moz-transition: all .1s ease-in; -o-transition: all .1s ease-in; -ms-transition: all .1s ease-in; transition: all .1s ease-in; } ul.nav-menu li span:hover, .sticky-header .menu-item a:hover, .sc_menu a:hover, .sc_menu a.tipsytext:hover { color: ' . $evolve_top_menu_hover_font_color . '; } ul.nav-menu .sf-with-ul:hover::after { color: ' . $evolve_top_menu_hover_font_color . '; } ul.nav-menu li:hover { background: ' . $evolve_top_menu_hover_color . ' none repeat scroll 0 0; } }';
    }

if ($menu_effect == 'rollover') {
$evolve_css_data .= '@media only screen and (min-width: 768px) { .link-effect a:hover span, .link-effect a:focus span { -webkit-transform: translateY(-100%); -moz-transform: translateY(-100%); transform: translateY(-100%); } }';
} else {
$evolve_css_data .= '.sub-menu .sub-menu a:after { position: absolute; }';
}
}

if ( is_home() || is_front_page() ) {
    if ($evolve_width_px && ( $evolve_frontpage_width_layout == "fixed" )) {
        $evolve_css_data .= '@media (min-width: ' . $evolve_min_width_px . 'px) { .container, #wrapper { width: ' . $evolve_width_px . 'px; } }';
    }  else {
        $evolve_css_data .= '@media (min-width: ' . $evolve_min_width_px . 'px) { .container { width: ' . $evolve_width_px . 'px; } .menu-back .container:first-child { width: 100%; padding-left: 0px; padding-right: 0px; } }';
    }
} else {
...
if ( is_home() || is_front_page() ) {
    if ($evolve_frontpage_width_layout == "fluid") {
        $evolve_css_data .= '/** * Basic 1 column (content)(aside) fluid layout * * @package WPEvoLve * @subpackage Layouts * @beta */ #wrapper { margin: 0; width: 100%; }';
    }  
...
$evolve_css_data .= 'body #header.sticky-header img#logo-image { max-width: ' . $evolve_sticky_header_logo_size . 'px; }';
...
$evolve_css_data .= 'ul.primary-menu-cont.nav-menu li:hover ul, ul.primary-menu-cont.nav-menu li.nav-hover ul { top: 40px; }';
    } 
elseif ($evolve_menu_font['font-size'] >= "14px") {
$evolve_css_data .= 'ul.primary-menu-cont.nav-menu li:hover ul, ul.primary-menu-cont.nav-menu li.nav-hover ul { top: 52px; }';
    }
...
$evolve_css_data .= '.header #logo-image { float: none; margin: 15px auto; }';

$evolve_css_data .= '.container .container-header { position: relative; }';

$evolve_css_data .= '.title-container { text-align: center; }';
    }
...
$evolve_css_data .= '#logo-image { float: right; margin: 15px 0px; } .header-logo-container { clear: right; } .sticky-header #logo { float: left; padding: 6px 6px 6px 3px; } .sticky-header #sticky-logo { float: left; padding: 0px 6px 0px 3px; }';
    }

if ($evolve_pos_logo == "left") {
$evolve_css_data .= '.sticky-header #logo { float: left; padding: 6px 6px 6px 3px; } .sticky-header #sticky-logo { float: left; padding: 0px 6px 0px 3px; } body #header.sticky-header img#logo-image { margin-left: 10px; }';
    }
...
$evolve_css_data .= '#wrapper { position: relative; margin: 0 auto 30px auto; background: #f9f9f9; box-shadow: 0 0 3px rgba(0, 0, 0, .2); } #wrapper:before { -webkit-box-shadow: 0 0 9px rgba(0, 0, 0, 0.6); -moz-box-shadow: 0 0 9px rgba(0, 0, 0, 0.6); box-shadow: 0 0 9px rgba(0, 0, 0, 0.6); left: 30px; right: 30px; position: absolute; z-index: -1; height: 20px; bottom: 0px; content: ""; -webkit-border-radius: 100px / 10px; -moz-border-radius: 100px / 10px; border-radius: 100px / 10px; }';
    }
...
$evolve_css_data .= '.header { padding-top: ' . $evolve_padding_top . '; padding-bottom: ' . $evolve_padding_bottom . '; } .header .container { padding-left: ' . $evolve_padding_left . '; padding-right: ' . $evolve_padding_right . '; } ul.nav-menu > li { padding: 0px ' . $evolve_menu_padding . 'px; }';

if ($evolve_header_image_src) {
$evolve_css_data .= '.custom-header { position: relative; border-bottom: 0; background-size: ' . $evolve_header_image . '; width: 100%; }';
    }
...
if ( is_home() || is_front_page() ) {
   if ($evolve_frontpage_width_layout == "fluid" || is_page_template('100-width.php')) {
        $evolve_css_data .= 'body #header.sticky-header { margin: 0px; left: 0px; width: 100%; }';
    }  
} elseif ($evolve_width_layout == "fluid" || is_page_template('100-width.php')) {
$evolve_css_data .= 'body #header.sticky-header { margin: 0px; left: 0px; width: 100%; }';
    }
...
$evolve_css_data .= '.t4p-reading-box-container a.button-default, button, .bootstrap-button, input#submit, .da-slide .da-link, span.more a, a.read-more, a.comment-reply-link, .entry-content a.t4p-button-default, .t4p-button, .reading-box .button, .continue.button, #wrapper .portfolio-one .button, #wrapper .comment-submit, #reviews input#submit, .comment-form input[type="submit"], .button, .button-default, .button.default, a.read-more, .tagcloud a:hover, h5.toggle.active a, h5.toggle.active a:hover, span.more a, .project-content .project-info .project-info-box a.button, input[type="submit"], .price_slider_amount button, .gform_wrapper .gform_button, .woocommerce-pagination .current, .widget_shopping_cart_content .buttons a, .woocommerce-success-message a.button, .woocommerce .order-again .button, .woocommerce-message .wc-forward, .woocommerce .wc-backward, .woocommerce .button.view, .product-buttons .add_to_cart_button, .product-buttons .button.product_type_grouped, .product-buttons .button.product_type_simple, .product-buttons .button.product_type_external, .wpcf7-form input.button, .wpcf7-form input[type="submit"], .wpcf7-submit, .woocommerce .single_add_to_cart_button, .woocommerce .button.view, .woocommerce .shipping-calculator-form .button, .woocommerce form.checkout #place_order, .woocommerce .checkout_coupon .button, .woocommerce .login .button, .woocommerce .register .button, .woocommerce .evolve-order-details .order-again .button, .t4p-accordian .panel-title a.active { background: ' . $evolve_shortcode_button_gradient_top_color . '; '; if ($evolve_shortcode_button_gradient_bottom_color) { $evolve_css_data .= ' background-image: -webkit-gradient( linear, left bottom, left top, from( ' . $evolve_shortcode_button_gradient_bottom_color . ' ), to( ' . $evolve_shortcode_button_gradient_top_color . ' ) ); background-image: -webkit-linear-gradient( bottom, ' . $evolve_shortcode_button_gradient_bottom_color . ', ' . $evolve_shortcode_button_gradient_top_color . ' ); background-image: -moz-linear-gradient( bottom, ' . $evolve_shortcode_button_gradient_bottom_color . ', ' . $evolve_shortcode_button_gradient_top_color . ' ); background-image: -o-linear-gradient( bottom, ' . $evolve_shortcode_button_gradient_bottom_color . ', ' . $evolve_shortcode_button_gradient_top_color . ' ); background-image: linear-gradient( to top, ' . $evolve_shortcode_button_gradient_bottom_color . ', ' . $evolve_shortcode_button_gradient_top_color . ' ); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=\'' . $evolve_shortcode_button_gradient_top_color . '\', endColorstr=\'' . $evolve_shortcode_button_gradient_bottom_color . '\' );';
    }
$evolve_css_data .= '}';
    }
...
$options = get_option('evl_options');
$evolve_css_data .= '/* Extra small devices (phones, <768px) */ @media (max-width: 768px) { .da-slide h2, #bootstrap-slider .carousel-caption h2 { font-size: 100%; letter-spacing: 1px; } #slide_holder .featured-title a { font-size: 80%; letter-spacing: 1px; } .da-slide p, #slide_holder p, #bootstrap-slider .carousel-caption p { font-size: 90%; } #wrapper .primary-menu .link-effect a.dd-selected{ display: inline-block !important; padding: 0; } #wrapper .primary-menu .link-effect a { line-height: normal; padding: 10px; } } /* Small devices (tablets, 768px) */ @media (min-width: 768px) { .da-slide h2 { font-size: 180%; letter-spacing: 0; } #slide_holder .featured-title a { font-size: 120%; letter-spacing: 0; } .da-slide p, #slide_holder p { font-size: 100%; } } /* Large devices (large desktops) */ @media (min-width: 992px) { .da-slide h2 { font-size: ' . $options['evl_parallax_slide_title_font']['font-size'] . '; line-height: 1em; } #slide_holder .featured-title a { font-size: ' . $options['evl_carousel_slide_title_font']['font-size'] . '; line-height: 1em; } .da-slide p { font-size: ' . $options['evl_parallax_slide_subtitle_font']['font-size'] . '; } #slide_holder p { font-size: ' . $options['evl_carousel_slide_subtitle_font']['font-size'] . '; } }';
...
$evolve_css_data .= '#wrapper, .entry-content .thumbnail-post, #search-text, #search-text-top:focus, ul.nav-menu ul, ul.breadcrumbs, .entry-content .wp-caption, thead, thead th, thead td, .home .type-post.sticky, .home .formatted-post, .page-template-blog-page-php .type-post.sticky, .page-template-blog-page-php .formatted-post, .tab-holder .tabs li a, .tab-holder .news-list li, #wrapper:before, #bbpress-forums .bbp-search-form #bbp_search, .bbp-search-form #bbp_search, .bbp-topic-form input#bbp_topic_title, .bbp-topic-form input#bbp_topic_tags, .bbp-topic-form select#bbp_stick_topic_select, .bbp-topic-form select#bbp_topic_status_select, .bbp-reply-form input#bbp_topic_tags, .widget-title-background, .widget-content, .widget:after { -webkit-box-shadow: none; -moz-box-shadow: none; -box-shadow: none; box-shadow: none; } ul.nav-menu a, .new_menu_class ul.menu a, .entry-title, .entry-title a, p#copyright .credits, p#copyright .credits a, .home .type-post.sticky .entry-header a, .home .formatted-post .entry-header a, .home .type-post.sticky .entry-meta, .home .formatted-post .entry-meta, .home .type-post.sticky .entry-footer a, .home .formatted-post .entry-footer a, .page-template-blog-page-php .type-post.sticky .entry-header a, .page-template-blog-page-php .type-post.sticky .entry-meta, .page-template-blog-page-php .formatted-post .entry-header a, .page-template-blog-page-php .formatted-post .entry-meta, .page-template-blog-page-php .type-post.sticky .entry-footer a, .page-template-blog-page-php .formatted-post .entry-footer a, .home .type-post.sticky .entry-title a, .home .formatted-post .entry-title a, .page-template-blog-page-php .type-post.sticky .entry-title a, .page-template-blog-page-php .formatted-post .entry-title a, .entry-meta, thead, thead th, thead td, .content-box i, .carousel-caption, .menu-header, body #header.sticky-header, .close, #content h3.widget-title, h3.widget-title { text-shadow: none; }';
    }
...
$evolve_css_data .= '.menu-header, .new_menu_class, form.top-searchform, .stuckMenu.isStuck .nav-menu, .p-menu-stick.stuckMenu .nav-menu, .p-menu-stick.stuckMenu.isStuck, body #header.sticky-header.sticky { filter: none; background: #' . $evolve_menu_back_color . '; border: none; border-radius: 0; -webkit-box-shadow: none; -moz-box-shadow: none; -box-shadow: none; box-shadow: none; } .menu-header:before, .menu-header:after { content: none; } ul.nav-menu li, ul.nav-menu li li, ul.nav-menu li li li, ul.nav-menu li li li li { border: none; } ul.nav-menu li.current-menu-item > a, ul.nav-menu li.current-menu-ancestor > a, ul.nav-menu li a:hover, ul.nav-menu li:hover > a, #wrapper .dd-container .dd-selected-text { box-shadow: none; }';

//disable all menu backgrounds, added by denzel

$evolve_css_data .= '.sub-menu, ul.nav-menu ul { border: none; } .menu-item a { border: none; }';

//make sticky menu background-color white, added by denzel

$evolve_css_data .= 'body #header.sticky-header { background: #' . $evolve_menu_back_color . '; border: 0; }';
    }

if ($evolve_responsive_menu == 'disable') {
$evolve_css_data .= '@media only screen and (max-width: 768px) { .nav-holder .dd-container, .top-menu .dd-container { display: none !important; } .nav-holder ul#menu-main-nav-menu, .top-menu .menu { display: block; } .top-menu-social-container { clear: both; } }';
    }
...
$evolve_css_data .= '#search-text, input#s, input#s .placeholder, #comment-input input, #comment-textarea textarea, #comment-input .placeholder, #comment-textarea .placeholder, .comment-form-comment textarea, .input-text, .post-password-form .password, .wpcf7-form .wpcf7-text, .wpcf7-form .wpcf7-quiz, .wpcf7-form .wpcf7-number, .wpcf7-form textarea, .wpcf7-form .wpcf7-select, .wpcf7-select-parent .select-arrow, .wpcf7-captchar, .wpcf7-form .wpcf7-date, .gform_wrapper .gfield input[type=text], .gform_wrapper .gfield input[type=email], .gform_wrapper .gfield textarea, .gform_wrapper .gfield select, #bbpress-forums .bbp-search-form #bbp_search, .bbp-reply-form input#bbp_topic_tags, .bbp-topic-form input#bbp_topic_title, .bbp-topic-form input#bbp_topic_tags, .bbp-topic-form select#bbp_stick_topic_select, .bbp-topic-form select#bbp_topic_status_select, #bbpress-forums div.bbp-the-content-wrapper textarea.bbp-the-content, .main-nav-search-form input, .search-page-search-form input, .chzn-container-single .chzn-single, .chzn-container .chzn-drop, .evolve-select-parent, .evolve-select-parent select, .evolve-select-parent .country_to_state, .evolve-select-parent .state_select, .select2-container .select2-choice>.select2-chosen, #wrapper .search-field input, input[type=text], input[type=email], input[type=password], input[type=file], textarea, select { color: '.$evolve_form_text_color.'; } input#s::-webkit-input-placeholder, #comment-input input::-webkit-input-placeholder, .post-password-form .password::-webkit-input-placeholder, #comment-textarea textarea::-webkit-input-placeholder, .comment-form-comment textarea::-webkit-input-placeholder, .input-text::-webkit-input-placeholder { color: '.$evolve_form_text_color.'; } input#s:-moz-placeholder, #comment-input input:-moz-placeholder, .post-password-form .password::-moz-input-placeholder, #comment-textarea textarea:-moz-placeholder, .comment-form-comment textarea:-moz-placeholder, .input-text:-moz-placeholder, input#s:-ms-input-placeholder, #comment-input input:-ms-input-placeholder, .post-password-form .password::-ms-input-placeholder, #comment-textarea textarea:-moz-placeholder, .comment-form-comment textarea:-ms-input-placeholder, .input-text:-ms-input-placeholder { color: '.$evolve_form_text_color.'; }';
...
$evolve_css_data .= 'ul.nav-menu li { float: left; position: relative; } ul.nav-menu li li:hover ul, ul.nav-menu li li.nav-hover ul, ul.nav-menu li li li:hover ul, ul.nav-menu li li li.nav-hover ul, ul.nav-menu li li li li:hover ul, ul.nav-menu li li li li.nav-hover ul { left: 14em; } ul.nav-menu ul { width: 14em !important; } ul.nav-menu ul ul { left: 14em !important; } ul.nav-menu ul li { width: 100%; } .center-menu ul.nav-menu li { display: inline-block; } ul.nav-menu, ul.nav-menu * { left: 0; }';
...
if ($evolve_header_image_src) {
$evolve_css_data .= '.header-bg { background: url(' . esc_url($evolve_header_image_src) . ') ' . $evolve_background_position . ' ' . $evolve_background_repeat . '; border-bottom: 0; background-size: ' . $evolve_header_image . '; width: 100%; height: 100%; position: absolute; }';
    }
...
$evolve_css_data .= '@media (min-width: 767px) and (max-width: '.$evolve_min_width_px.'px) { body.admin-bar #header.sticky-header{ width: 100%; margin-left:0; } }';