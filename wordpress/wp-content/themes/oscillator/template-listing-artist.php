...
<div class="row">
	<div class="col-xs-12">
		...
		<?php while ( have_posts() ): the_post(); ?>
			...
			<?php
				$cpt            = 'oscillator_artist';
				$cpt_taxonomy   = 'oscillator_artist_category';
				$base_category  = get_post_meta( get_the_ID(), 'oscillator_artist_listing_base_category', true );
				$isotope        = get_post_meta( get_the_ID(), 'oscillator_artist_listing_isotope', true );
				$columns        = get_post_meta( get_the_ID(), 'oscillator_artist_listing_columns', true );
				$masonry        = get_post_meta( get_the_ID(), 'oscillator_artist_listing_masonry', true );
				$posts_per_page = get_post_meta( get_the_ID(), 'oscillator_artist_listing_posts_per_page', true );
