<?php
if ( ! function_exists( 'oscillator_pagination' ) ):
	/**
	 ...
	 * @return void
	 */
	function oscillator_pagination( $args = array(), $query = false ) {
		$args = wp_parse_args( $args, apply_filters( 'oscillator_pagination_default_args', array(
			'container_id'        => 'paging',
			'container_class'     => 'group',
			'prev_text'           => __( 'Previous page', 'oscillator' ),
			'next_text'           => __( 'Next page', 'oscillator' ),
