...
get_header(); ?>
	...
	<main>
		<section id="events">
			<div class="container">
				<div class="row">						
					<div class="col-md-12 latest-artist">
						<h2><?php _e( 'Nossos', 'ta-music' ); ?> <span><?php _e( 'Artistas', 'ta-music' ); ?></span> <a href="<?php if ( !empty( ta_option( 'artists_page' ) ) ) { echo get_permalink( ta_option( 'artists_page' ) ); } ?>" class="view-all"><span><?php _e( 'View All', 'ta-music' ); ?></span> <i class="fa fa-angle-double-right view-all-icon"></i></a></h2>
						<div class="row">
						<?php
							$args = array(
								'role'    => 'author',
		...
		<section id="latest-content">
			<div class="container">
				<div class="row">
					<div class="col-md-12 latest-videos">
						<h2><?php _e( 'Ultimos', 'ta-music' ); ?> <span><?php _e( 'Videos', 'ta-music' ); ?></span> <a href="<?php echo get_post_format_link( 'video' ); ?>" class="view-all"><span><?php _e( 'Veja Todos', 'ta-music' ); ?></span> <i class="fa fa-angle-double-right view-all-icon"></i></a></h2>
						<div class="row">
						<?php
							$args = array(
								'post_type'    => 'post',
