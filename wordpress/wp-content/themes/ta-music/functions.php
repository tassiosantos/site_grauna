 ...
 * to change 'ta_music' to the name of your theme in all the template files
 */
load_theme_textdomain( 'ta_music', get_template_directory() . '/languages' );
...
function ta_music_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'ta_music' ),
	) );
