...
<div id="page" class="hfeed site">
	<a class="sr-only" href="#content"><?php _e( 'Skip to content', 'ta_music' ); ?></a>
	...
	<div id="top-bar">
		...
		<?php } ?>
			...
			<?php if ( ta_option( 'disable_login_register' ) == '1' ) { ?>
				<li class="login"><a href="<?php echo wp_login_url( get_permalink() ); ?>"><i class="fa fa-lock"></i><span><?php _e( 'Login', 'ta_music' ); ?></span></a></li>
				<li class="register"><a href="<?php echo wp_registration_url(); ?>"><i class="fa fa-user"></i><span><?php _e( 'Register', 'ta_music' ); ?></span></a></li>
			<?php } ?>
