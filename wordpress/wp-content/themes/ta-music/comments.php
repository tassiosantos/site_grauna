...
<div id="leave-comment">
	...
	$comments_args = array(
		...
		'label_submit' => __( 'Submit Comment', 'ta_music' ),
		// change the title of the reply section
		'title_reply' => __( 'Leave a <span>Comment</span>', 'ta_music' ),
		...
		'fields' => apply_filters( 'comment_form_default_fields', array(
			'author' =>
			  '<label for="name">' . __( 'Your Name', 'ta_music' ) . '</label> ' .
			  '<input type="text" name="author" id="name" value="' . esc_attr( $commenter['comment_author'] ) . '"' . $aria_req . ' />',

			'email' =>
			  '<label for="email">' . __( 'Your E-Mail', 'ta_music' ) . '</label> ' .
